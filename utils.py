...
# The updated version, add global patch
class FullImagePatchWithGlobalDataset3D(Dataset):
    def __init__(self, image_dir, label_dir=None, patch_size=64, stride=32):
        self.image_dir = image_dir
        self.label_dir = label_dir
        self.patch_size = patch_size
...
class BalancedLesionPatchWithGlobalDataset3D(Dataset):
    def __init__(
        self,
        image_dir,
        label_dir,
